...
local S = cottages.S
-- some of this depends on textures and items from farming: which not all games include
...
if farming_enabled then -- depends on textures from farming
...
if farming_enabled then -- needs farming:wheat which not all games provide
